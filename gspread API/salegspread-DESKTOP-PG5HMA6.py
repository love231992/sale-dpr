...
def detailsheet():
    ...
    df = pd.read_excel(open(r"Y:\Ash\FY 2019-20\Sale detail sheet\SALE DETAIL SHEET MARCH 2020.xlsx",'rb'),sheet_name= "MARCH" ,index_col=None, header=None,skiprows=1) 
    return df
