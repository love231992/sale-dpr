...
def dpr_sale(customer_list):
    ...
    for i in customer_list:
        ...
        # print(a)
        b= (ab[ab[6]== today][8]).count()
        # print(b)
        sum_list.append(round(a,2))
        count_list.append(b)
        return count_list,sum_list    
# ******************************************** Connect to PSPCL and get plant loads in MegaWatt **************************************
def load():
    options = Options()
...
# ******************************************** Advance Balance **************************************
        ...
        wb = app.books.open(r'\\10.9.32.2\adm\Ash\FY 2019-20\DAILY REPORT\DAILY REPORT FORMAT.xlsx') # Daily report connection
...
# ******************************************** Month revenue ***************************
    ...
    return render(request,"home.html",{'per':per,'ash_utilization': ash_utilization,'revenue':revenue,'total1':total1,'today_total':today_total,'yester_total':yester_total,'yesterday':yesterday,'d1':d1,'month':month,'pond_ash':pond_ash}) 
